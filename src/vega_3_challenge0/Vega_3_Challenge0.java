 ...
 */
package vega_3_challenge0;

/**
 *
 * @author andrewvega3
 */
public class Vega_3_Challenge0 {
    ...
    } else if (isDivisible3(i) && isDivisible5(i)){
            System.out.println("Old School");
    
    } else if (isDivisible2(i) && isDivisible3(i)){
            System.out.println("chismé");
    
    } else if (isDivisible2(i) && isDivisible3(i) & isDivisible5(i)){
